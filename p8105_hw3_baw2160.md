...
![](p8105_hw3_baw2160_files/figure-markdown_github/unnamed-chunk-14-1.png) Make a two-panel plot showing (i) tmax vs tmin for the full dataset (note that a scatterplot may not be the best option);
